...
import (
	...
	"github.com/n4de4k/web-api-boilerplate/api/rest/internal"
	"github.com/n4de4k/web-api-boilerplate/app/component"
	"log"
	"net/http"
	"os"
	"os/signal"
...
func NewHandler(serviceComponent component.ServiceComponent) *Handler {
